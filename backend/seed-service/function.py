...
def generate_individuals(count):
    ...
    for i in range(count):
        ...
        inds.append({
            ...
            "first_name": fname,
            "last_name": lname,
            "is_direct_staff": random.random() > 0.2,
...
def run_seed():
    ...
    with conn.cursor() as cur:
        ...
        raw_inds[1] = {"employee_id": "EMP-0002", "email": "sjenkins@acme.com", "first_name": "Sarah", "last_name": "Jenkins", "is_direct_staff": False, "designation": "Chief Revenue Officer", "location": "New York, NY", "location_lat": 40.7128, "location_lng": -74.0060}
        raw_inds[2] = {"employee_id": "EMP-0003", "email": "amercer@acme.com", "first_name": "Alex", "last_name": "Mercer", "is_direct_staff": True, "designation": "Senior Frontend Engineer", "location": "Austin, TX", "location_lat": 30.2672, "location_lng": -97.7431}
        raw_inds[3] = {"employee_id": "EMP-0004", "email": "dkim@acme.com", "first_name": "David", "last_name": "Kim", "is_direct_staff": False, "designation": "Core Services Engineering Manager", "location": "London, UK", "location_lat": 51.5074, "location_lng": -0.1278}
        raw_inds[4] = {"employee_id": "EMP-0005", "email": "erodriguez@acme.com", "first_name": "Elena", "last_name": "Rodriguez", "is_direct_staff": False, "designation": "HR Business Partner", "location": "Berlin, DE", "location_lat": 52.5200, "location_lng": 13.4050}
        
        inserted_inds = []
        for i in raw_inds:
            try:
                cur.execute(
                    "INSERT INTO individuals (employee_id, email, first_name, last_name, is_direct_staff, designation, location, location_lat, location_lng) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s) RETURNING id, email, first_name, designation",
                    (i["employee_id"], i["email"], i["first_name"], i["last_name"], i["is_direct_staff"], i["designation"], i["location"], i.get("location_lat"), i.get("location_lng"))
                )
        ...
        for idx in range(40):
            ...
            cur.execute(
                ...
                (username, ind_email, standard_hash, role)
            )
